    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.sendReport.setOnClickListener {
            ...
            getCurrentLocation { userLocation ->
                ...
                val fullMessage = buildReportMessage(name, location, fireReport, station.name)
                confirmSendSms(station.contact, fullMessage, userLocation, station.name)
            }
        }
    }
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            for (report in pendingReports) {
                val reportMap = mapOf(
                    ...
                    "fireStationName" to station.name,
